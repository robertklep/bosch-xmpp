...
class NefitEasyClient extends BaseClient {
  // Nefit requires particular EOL handling in XMPP stanzas.
  // Override buildMessage to ensure \r is XML-encoded as &#13;\n in the serialized output.
  buildMessage(body) {
    const msg = super.buildMessage(body);
    const origToString = msg.toString.bind(msg);
    msg.toString = function() {
      return origToString().replace(/\r/g, '&#13;\n');
    };
    return msg;
  }
